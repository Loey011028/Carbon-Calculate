(function (root) {
  ...
  const FactorBuiltinCategoryTree = [
    {
      groupCode: "factor_energy_fuel",
      groupLabel: "能源与燃料",
      children: [
        { category: "factor_fossil_fuel", categoryLabel: "化石燃料" },
        { category: "factor_biomass_fuel", categoryLabel: "生物质燃料" },
        { category: "factor_solar_energy", categoryLabel: "太阳能" },
        { category: "factor_wind_energy", categoryLabel: "风能" },
        { category: "factor_hydropower", categoryLabel: "水能" },
        { category: "factor_nuclear_energy", categoryLabel: "核能" },
        { category: "factor_hydrogen_energy", categoryLabel: "氢能" },
        { category: "factor_geothermal_energy", categoryLabel: "地热能" },
        { category: "factor_ocean_energy", categoryLabel: "海洋能" },
        { category: "factor_energy_storage", categoryLabel: "储能系统" },
        { category: "factor_waste_heat_recovery", categoryLabel: "余热利用" },
        { category: "factor_purchased_electricity", categoryLabel: "外购电力" },
        { category: "factor_purchased_heat_cooling", categoryLabel: "外购热力与冷能" }
      ]
    },
    {
      groupCode: "factor_industrial_process",
      groupLabel: "工业过程",
      children: [
        { category: "factor_mineral_processing", categoryLabel: "矿物加工" },
        { category: "factor_metal_smelting", categoryLabel: "金属冶炼" },
        { category: "factor_chemical_production", categoryLabel: "化工生产" },
        { category: "factor_refining_coal_chemical", categoryLabel: "石油炼制与煤化工" },
        { category: "factor_electronics_semiconductor", categoryLabel: "电子与半导体" },
        { category: "factor_food_beverage_processing", categoryLabel: "食品与饮料加工" },
        { category: "factor_textile_printing_dyeing", categoryLabel: "纺织与印染" },
        { category: "factor_paper_products", categoryLabel: "造纸与纸制品" },
        { category: "factor_other_industrial_process", categoryLabel: "其他工业过程" }
      ]
    },
    {
      groupCode: "factor_transport_logistics",
      groupLabel: "运输物流",
      children: [
        { category: "factor_road_transport", categoryLabel: "公路运输" },
        { category: "factor_rail_transport", categoryLabel: "铁路运输" },
        { category: "factor_water_transport", categoryLabel: "水路运输" },
        { category: "factor_air_transport", categoryLabel: "航空运输" },
        { category: "factor_pipeline_transport", categoryLabel: "管道运输" },
        { category: "factor_warehousing_logistics", categoryLabel: "仓储与物流中心" }
      ]
    },
    {
      groupCode: "factor_materials",
      groupLabel: "原材料与物料",
      children: [
        { category: "factor_metal_materials", categoryLabel: "金属材料" },
        { category: "factor_nonmetal_materials", categoryLabel: "非金属材料" },
        { category: "factor_plastic_polymer_materials", categoryLabel: "塑料与高分子材料" },
        { category: "factor_rubber_elastomer", categoryLabel: "橡胶与弹性体" },
        { category: "factor_chemical_raw_materials", categoryLabel: "化工原料" },
        { category: "factor_coatings_adhesives", categoryLabel: "涂料与胶粘剂" },
        { category: "factor_pharmaceutical_materials", categoryLabel: "医药与制药材料" },
        { category: "factor_food_beverage_raw_materials", categoryLabel: "食品与饮料原料" },
        { category: "factor_paper_raw_materials", categoryLabel: "造纸原料" },
        { category: "factor_electronic_components", categoryLabel: "电子元器件" },
        { category: "factor_bio_based_materials", categoryLabel: "生物基材料" },
        { category: "factor_textile_fiber_materials", categoryLabel: "纺织与纤维材料" },
        { category: "factor_industrial_water_auxiliaries", categoryLabel: "工业用水与辅料" },
        { category: "factor_other_materials", categoryLabel: "其他材料" }
      ]
    },
    {
      groupCode: "factor_waste_treatment",
      groupLabel: "废弃物处理",
      children: [
        { category: "factor_solid_waste", categoryLabel: "固体废弃物" },
        { category: "factor_liquid_waste", categoryLabel: "液体废弃物" },
        { category: "factor_gas_emission", categoryLabel: "气体排放" },
        { category: "factor_hazardous_waste", categoryLabel: "危险废弃物" },
        { category: "factor_recycling_reuse", categoryLabel: "回收再利用" }
      ]
    },
    {
      groupCode: "factor_refrigeration_fugitive",
      groupLabel: "制冷与逸散",
      children: [
        { category: "factor_refrigerant_leakage", categoryLabel: "制冷剂泄漏" },
        { category: "factor_sf6_emission", categoryLabel: "SF6排放" },
        { category: "factor_natural_gas_fugitive", categoryLabel: "天然气逸散" },
        { category: "factor_vocs_fugitive", categoryLabel: "VOCs逸散" },
        { category: "factor_other_fugitive", categoryLabel: "其他逸散" }
      ]
    },
    {
      groupCode: "factor_packaging_materials",
      groupLabel: "包装材料",
      children: [
        { category: "factor_paper_packaging", categoryLabel: "纸制品包装" },
        { category: "factor_plastic_packaging", categoryLabel: "塑料包装" },
        { category: "factor_metal_packaging", categoryLabel: "金属包装" },
        { category: "factor_wood_packaging", categoryLabel: "木质包装" },
        { category: "factor_composite_packaging", categoryLabel: "复合包装" }
      ]
    },
    {
      groupCode: "factor_product_use",
      groupLabel: "产品使用阶段",
      children: [
        { category: "factor_energy_using_products", categoryLabel: "耗能产品使用" },
        { category: "factor_fluorinated_products", categoryLabel: "含氟产品使用" },
        { category: "factor_fuel_product_combustion", categoryLabel: "燃料产品燃烧" },
        { category: "factor_non_energy_products", categoryLabel: "非耗能产品使用" }
      ]
    },
    {
      groupCode: "factor_product_disposal",
      groupLabel: "产品处置阶段",
      children: [
        { category: "factor_landfill_disposal", categoryLabel: "填埋处置" },
        { category: "factor_incineration_disposal", categoryLabel: "焚烧处置" },
        { category: "factor_disposal_recycling_reuse", categoryLabel: "回收再利用" },
        { category: "factor_composting", categoryLabel: "堆肥" }
      ]
    },
    {
      groupCode: "factor_construction",
      groupLabel: "建筑与施工",
      children: [
        { category: "factor_building_materials", categoryLabel: "建筑材料" },
        { category: "factor_construction_process", categoryLabel: "施工过程" },
        { category: "factor_building_equipment_systems", categoryLabel: "建筑设备与系统" },
        { category: "factor_operation_maintenance", categoryLabel: "运营维护" },
        { category: "factor_demolition_disposal", categoryLabel: "拆除处置" }
      ]
    },
    {
      groupCode: "factor_agriculture_land_use",
      groupLabel: "农业与土地利用",
      children: [
        { category: "factor_crop_farming", categoryLabel: "种植业" },
        { category: "factor_animal_husbandry", categoryLabel: "畜牧业" },
        { category: "factor_forestry_carbon_sink", categoryLabel: "林业与碳汇" },
        { category: "factor_land_use_change", categoryLabel: "土地利用变化" },
        { category: "factor_fishery_aquaculture", categoryLabel: "渔业与水产" }
      ]
    },
    {
      groupCode: "factor_business_activities",
      groupLabel: "商务活动",
      children: [
        { category: "factor_business_travel", categoryLabel: "商务差旅" },
        { category: "factor_employee_commuting", categoryLabel: "员工通勤" },
        { category: "factor_hotel_accommodation", categoryLabel: "酒店住宿" },
        { category: "factor_office_operations", categoryLabel: "办公运营" },
        { category: "factor_it_data_center", categoryLabel: "IT与数据中心" },
        { category: "factor_meetings_exhibitions", categoryLabel: "会议与会展" }
      ]
    },
    {
      groupCode: "factor_custom",
      groupLabel: "自定义",
      children: [
        { category: "factor_user_custom", categoryLabel: "用户自定义" }
      ]
    }
  ];
  ...
  const DataSources = [
    ...
    { id: "ds-11", name: "锦浪光伏 API", type: "api", groupKey: "api", meterType: "ginlong-pv", meterTypeLabel: "锦浪光伏", unit: "kWh", org: "华东园区", frequency: "接口同步", status: "在线", time: "2026-07-15 10:30", apiPlatform: "ginlong-pv", apiPlatformLabel: "锦浪光伏", apiEnergyType: "光伏", energyType: "光伏", url: "https://api.ginlong.com:13333", apiKeyId: "1300386381677078825", apiSecret: "d0d001f0ddd241fda3f32536cd0bb23a" },
    {
      id: "ds-12",
      name: "锅炉房月度 Excel 台账",
      type: "excel",
      groupKey: "excel",
      meterType: "excel-ledger",
      meterTypeLabel: "Excel台账",
      unit: "Nm³",
      energyType: "天然气",
      energyUnit: "Nm³",
      ...
      frequency: "按次导入",
      status: "在线",
      template: "数据上报模板.xlsx",
      fileName: "锅炉房月度能耗_2026Q2.xlsx",
      excelRows: [
        { energyAmount: 1180, timeGranularity: "月", timeDimension: "2026-04", belongingSpace: "锅炉房" },
        { energyAmount: 1265, timeGranularity: "月", timeDimension: "2026-05", belongingSpace: "锅炉房" },
        { energyAmount: 1328, timeGranularity: "月", timeDimension: "2026-06", belongingSpace: "锅炉房" },
        { energyAmount: 1360, timeGranularity: "月", timeDimension: "2026-07", belongingSpace: "锅炉房" }
      ]
    }
  ];

  const DataSourceCategoryTree = [
    { groupKey: "smart-meter", groupLabel: "智能表计", type: "smart-meter", icon: "domain", children: [
      { key: "electric", label: "电表", unit: "kWh" },
      { key: "water", label: "水表", unit: "m³" },
      { key: "gas", label: "燃气表", unit: "Nm³" },
      { key: "heat", label: "热表", unit: "GJ" }
    ] },
    { groupKey: "manual", groupLabel: "手工填报", type: "manual", icon: "description", children: [
      { key: "refrigerant", label: "制冷剂台账", unit: "kg" },
      { key: "fuel-ledger", label: "燃料台账", unit: "L" },
      { key: "commute-ledger", label: "通勤台账", unit: "人次" }
    ] },
    { groupKey: "api", groupLabel: "API接口", type: "api", icon: "cloud", children: [
      { key: "ginlong-pv", label: "锦浪光伏", unit: "kWh" },
      { key: "sungrow-pv", label: "阳光光伏", unit: "kWh" },
      { key: "biogas-platform", label: "沼气平台", unit: "Nm³" },
      { key: "energy-iot-platform", label: "综合能源平台", unit: "kWh" }
    ] },
    { groupKey: "excel", groupLabel: "Excel导入", type: "excel", icon: "file_download", children: [
      { key: "excel-ledger", label: "Excel台账", unit: "条" },
      { key: "production-excel", label: "生产数据台账", unit: "条" }
    ] }
  ];
  ...
  const ActivityDataRecords = [
    ...
    { id: "adr-4", datasourceId: "ds-3", sourceId: "es-refrigerant-r410a", period: "2026-06", amount: 18.5, unit: "kg", quality: "待复核", collectedAt: "2026-06-28 18:00", status: "待确认", energyType: "R410A", timeGranularity: "月", belongingSpace: "办公楼" },
    { id: "adr-5", datasourceId: "ds-3", sourceId: "es-refrigerant-r410a", period: "2026-05", amount: 12, unit: "kg", quality: "通过", collectedAt: "2026-05-31 18:00", status: "已入库", energyType: "R410A", timeGranularity: "月", belongingSpace: "办公楼" },
    ...
    { id: "adr-8", datasourceId: "ds-10", sourceId: "es-emergency-diesel-generator", period: "2026-06-29", amount: 320, unit: "L", quality: "通过", collectedAt: "2026-06-29 09:20", status: "已入库", energyType: "柴油", timeGranularity: "日", belongingSpace: "仓储区" },
    { id: "adr-9", datasourceId: "ds-10", sourceId: "es-emergency-diesel-generator", period: "2026-06-22", amount: 280, unit: "L", quality: "通过", collectedAt: "2026-06-22 09:20", status: "已入库", energyType: "柴油", timeGranularity: "日", belongingSpace: "仓储区" },
    { id: "adr-12-1", datasourceId: "ds-12", sourceId: "", period: "2026-04", amount: 1180, unit: "Nm³", quality: "通过", collectedAt: "2026-04-30 18:00", status: "已入库", energyType: "天然气", timeGranularity: "月", belongingSpace: "锅炉房" },
    { id: "adr-12-2", datasourceId: "ds-12", sourceId: "", period: "2026-05", amount: 1265, unit: "Nm³", quality: "通过", collectedAt: "2026-05-31 18:00", status: "已入库", energyType: "天然气", timeGranularity: "月", belongingSpace: "锅炉房" },
    { id: "adr-12-3", datasourceId: "ds-12", sourceId: "", period: "2026-06", amount: 1328, unit: "Nm³", quality: "通过", collectedAt: "2026-06-30 18:00", status: "已入库", energyType: "天然气", timeGranularity: "月", belongingSpace: "锅炉房" },
    { id: "adr-12-4", datasourceId: "ds-12", sourceId: "", period: "2026-07", amount: 1360, unit: "Nm³", quality: "待复核", collectedAt: "2026-07-15 18:00", status: "待确认", energyType: "天然气", timeGranularity: "月", belongingSpace: "锅炉房" }
  ];
  ...
  const FactorCategoryAccountingMap = {
    factor_purchased_electricity: {
      scope: "scope2",
  ...
  const SourceFactorCategoryAssignments = {
    purchased_electricity: {
      groupCode: "factor_energy_fuel",
      groupLabel: "能源与燃料",
      categoryCode: "factor_purchased_electricity",
      categoryLabel: "外购电力"
    },
    stationary_combustion: {
      groupCode: "factor_energy_fuel",
      groupLabel: "能源与燃料",
      categoryCode: "factor_fossil_fuel",
      categoryLabel: "化石燃料"
    },
    fugitive_emission: {
      groupCode: "factor_refrigeration_fugitive",
      groupLabel: "制冷与逸散",
      categoryCode: "factor_refrigerant_leakage",
      categoryLabel: "制冷剂泄漏"
    }
  };
  ...
  const AccountingModels = [
  {
    ...
    categoryLabel: "固定燃烧",
    activityDataType: "fuel_consumption",
    standardId: "std-ghgp-corporate-revised",
  ...
  },
  {
    ...
    categoryLabel: "逸散排放",
    activityDataType: "replenishment_amount",
    standardId: "std-iso-14064-1-2018",
    standard: "ISO 14064-1:2018 Greenhouse gases - Part 1",
    method: "排放因子法",
  ...
  const StandardFiles = [
    {
      id: "std-iso-14064-1-2018",
      name: "ISO 14064-1:2018 Greenhouse gases - Part 1",
      code: "ISO 14064-1:2018",
      issuer: "ISO",
      year: "2018",
      type: "组织层面温室气体量化与报告标准",
      fileName: "ISO 14064-1:2018 official standard page",
      fileType: "text/html",
      fileSize: 0,
      uploadedAt: "2026-07-21 00:00",
      remark: "ISO 官方标准记录页。ISO 正文为授权标准，系统维护官方来源链接，不内置未授权 PDF。",
      enabled: true,
      builtIn: true,
      dataUrl: "",
      fileUrl: "https://www.iso.org/standard/66453.html",
      referenceUrl: "https://www.iso.org/standard/66453.html"
    },
    {
      id: "std-iso-14064-3-2019",
      name: "ISO 14064-3:2019 Greenhouse gases - Part 3",
      code: "ISO 14064-3:2019",
      issuer: "ISO",
      year: "2019",
      type: "温室气体声明审定与核证规范",
      fileName: "ISO 14064-3:2019 official standard page",
      fileType: "text/html",
      fileSize: 0,
      uploadedAt: "2026-07-21 00:00",
      remark: "ISO 官方标准记录页。ISO 正文为授权标准，系统维护官方来源链接，不内置未授权 PDF。",
      ...
      builtIn: true,
      dataUrl: "",
      fileUrl: "https://www.iso.org/standard/66455.html",
      referenceUrl: "https://www.iso.org/standard/66455.html"
    },
    {
      id: "std-ghgp-corporate-revised",
      name: "GHG Protocol Corporate Accounting and Reporting Standard",
      code: "GHG-PROTOCOL-CORPORATE-REVISED",
      issuer: "World Resources Institute / WBCSD",
      year: "2004",
      type: "企业温室气体核算与报告标准",
      fileName: "ghg-protocol-revised.pdf",
      fileType: "application/pdf",
      fileSize: 0,
      uploadedAt: "2026-07-21 00:00",
      remark: "GHG Protocol 官方企业核算与报告标准 PDF。",
      enabled: false,
      builtIn: true,
      dataUrl: "",
    ...
    {
      id: "std-ghgp-scope-2-guidance",
      name: "GHG Protocol Scope 2 Guidance",
      code: "GHG-PROTOCOL-SCOPE-2-GUIDANCE",
      issuer: "World Resources Institute",
      year: "2015",
      type: "范围二核算指南",
      fileName: "ghg-protocol-scope-2-guidance.pdf",
      fileType: "application/pdf",
      fileSize: 0,
      uploadedAt: "2026-07-21 00:00",
      remark: "GHG Protocol 官方范围二核算指南 PDF。",
      enabled: false,
      builtIn: true,
      dataUrl: "",
      fileUrl: "https://ghgprotocol.org/sites/default/files/standards/ghg-protocol-scope-2-guidance.pdf",
      referenceUrl: "https://ghgprotocol.org/scope-2-guidance"
    },
    {
      id: "std-ghgp-scope-3-standard",
      name: "GHG Protocol Corporate Value Chain (Scope 3) Standard",
      code: "GHG-PROTOCOL-SCOPE-3-STANDARD",
      issuer: "World Resources Institute / WBCSD",
      year: "2011",
      type: "范围三价值链核算与报告标准",
      fileName: "Corporate-Value-Chain-Accounting-Reporing-Standard_041613_2.pdf",
      fileType: "application/pdf",
      fileSize: 0,
      uploadedAt: "2026-07-21 00:00",
      remark: "GHG Protocol 官方范围三价值链核算与报告标准 PDF。",
      enabled: false,
      builtIn: true,
      dataUrl: "",
      fileUrl: "https://ghgprotocol.org/sites/default/files/standards/Corporate-Value-Chain-Accounting-Reporing-Standard_041613_2.pdf",
      referenceUrl: "https://ghgprotocol.org/corporate-value-chain-scope-3-standard"
    }
  ];

  function ensureSingleStandardFileEnabled(rows = []) {
    let enabledSeen = false;
    const normalized = rows.map((item, index) => {
      const shouldEnable = item.enabled === true && !enabledSeen;
      if (shouldEnable) enabledSeen = true;
      return { ...item, enabled: shouldEnable };
    });
    if (!enabledSeen && normalized[0]) normalized[0].enabled = true;
    return normalized;
  }
...
const ModelStandardRules = {
  ...
  fugitive_emission: {
    defaultStandardId: "std-iso-14064-1-2018",
    activityDataType: "replenishment_amount",
...
function getDefaultFactorMatchFields(categoryCode) {
  ...
  const FactorLibraryFactors = [
    { id: "ef-natural-gas-co2", name: "天然气锅炉燃烧CO₂因子", code: "EF_NG_BOILER_CO2", category: "固定燃烧 / 厂区锅炉 / 天然气", standardId: "std-ghgp-corporate-revised", gwp: "AR6 (GWP100)", gases: [{ gas: "CO₂", value: "2.162", unit: "kgCO₂/Nm³" }], region: "全国", scope: "范围一", source: "国家发展改革委", startDate: "2024-01-01", endDate: "", status: "启用" },
    { id: "ef-natural-gas-ch4", name: "天然气锅炉燃烧CH₄因子", code: "EF_NG_BOILER_CH4", category: "固定燃烧 / 厂区锅炉 / 天然气", standardId: "std-ghgp-corporate-revised", gwp: "AR6 (GWP100)", gases: [{ gas: "CH₄", value: "0.00012", unit: "kgCH₄/Nm³" }], region: "全国", scope: "范围一", source: "国家发展改革委", startDate: "2024-01-01", endDate: "", status: "启用" },
    { id: "ef-natural-gas-n2o", name: "天然气锅炉燃烧N₂O因子", code: "EF_NG_BOILER_N2O", category: "固定燃烧 / 厂区锅炉 / 天然气", standardId: "std-ghgp-corporate-revised", gwp: "AR6 (GWP100)", gases: [{ gas: "N₂O", value: "0.00003", unit: "kgN₂O/Nm³" }], region: "全国", scope: "范围一", source: "国家发展改革委", startDate: "2024-01-01", endDate: "", status: "启用" },
    { id: "ef-diesel-generator-co2", name: "柴油发电机燃烧CO₂因子", code: "EF_DIESEL_GEN_CO2", category: "固定燃烧 / 柴油发电机 / 柴油", standardId: "std-ghgp-corporate-revised", gwp: "AR6 (GWP100)", gases: [{ gas: "CO₂", value: "2.676", unit: "kgCO₂/L" }], region: "全国", scope: "范围一", source: "国家发展改革委", startDate: "2024-01-01", endDate: "", status: "启用" },
    { id: "ef-diesel-generator-ch4", name: "柴油发电机燃烧CH₄因子", code: "EF_DIESEL_GEN_CH4", category: "固定燃烧 / 柴油发电机 / 柴油", standardId: "std-ghgp-corporate-revised", gwp: "AR6 (GWP100)", gases: [{ gas: "CH₄", value: "0.00013", unit: "kgCH₄/L" }], region: "全国", scope: "范围一", source: "国家发展改革委", startDate: "2024-01-01", endDate: "", status: "启用" },
    { id: "ef-diesel-generator-n2o", name: "柴油发电机燃烧N₂O因子", code: "EF_DIESEL_GEN_N2O", category: "固定燃烧 / 柴油发电机 / 柴油", standardId: "std-ghgp-corporate-revised", gwp: "AR6 (GWP100)", gases: [{ gas: "N₂O", value: "0.000024", unit: "kgN₂O/L" }], region: "全国", scope: "范围一", source: "国家发展改革委", startDate: "2024-01-01", endDate: "", status: "启用" },
    { id: "ef-national-grid-co2", name: "华东电网外购电力CO₂因子", code: "EF_CN_GRID_2022_CO2", category: "外购电力 / 华东电网", standardId: "std-ghgp-scope-2-guidance", gwp: "AR6 (GWP100)", gases: [{ gas: "CO₂", value: "0.5366", unit: "kgCO₂/kWh" }], region: "华东电网", scope: "范围二", source: "生态环境部 / 国家统计局", startDate: "2024-01-01", endDate: "", status: "启用" },
    { id: "ef-r410a-leakage", name: "R410A制冷剂泄漏因子", code: "EF_R410A_LEAK", category: "逸散排放 / 制冷剂泄漏 / R410A", standardId: "std-iso-14064-1-2018", gwp: "AR6 (GWP100)", factorType: "refrigerant", value: "1", unit: "kgR410A/kg", gases: [{ gas: "HFC-32", ratio: 0.5, value: 1, unit: "kgR410A/kg" }, { gas: "HFC-125", ratio: 0.5, value: 1, unit: "kgR410A/kg" }], components: [{ gas: "HFC-32", ratio: 0.5 }, { gas: "HFC-125", ratio: 0.5 }], region: "全国", scope: "范围一", source: "IPCC", startDate: "2024-01-01", endDate: "", status: "启用" }
  ];

  const FactorLibraryGroups = [
    { id: "fg-natural-gas", name: "天然气锅炉燃烧因子组", code: "FG_NG_BOILER", category: "固定燃烧 / 厂区锅炉 / 天然气", standardId: "std-ghgp-corporate-revised", gwp: "AR6 (GWP100)", gases: [{ gas: "CO₂", value: "2.162", unit: "kgCO₂/Nm³" }, { gas: "CH₄", value: "0.00012", unit: "kgCH₄/Nm³" }, { gas: "N₂O", value: "0.00003", unit: "kgN₂O/Nm³" }], region: "全国", scope: "范围一", source: "国家发展改革委", startDate: "2024-01-01", endDate: "", status: "启用" },
    { id: "fg-diesel", name: "柴油发电机燃烧因子组", code: "FG_DIESEL_GEN", category: "固定燃烧 / 柴油发电机 / 柴油", standardId: "std-ghgp-corporate-revised", gwp: "AR6 (GWP100)", gases: [{ gas: "CO₂", value: "2.676", unit: "kgCO₂/L" }, { gas: "CH₄", value: "0.00013", unit: "kgCH₄/L" }, { gas: "N₂O", value: "0.000024", unit: "kgN₂O/L" }], region: "全国", scope: "范围一", source: "国家发展改革委", startDate: "2024-01-01", endDate: "", status: "启用" },
    { id: "fg-east-china-grid", name: "华东电网外购电力因子组", code: "FG_CN_GRID_2022", category: "外购电力 / 华东电网", standardId: "std-ghgp-scope-2-guidance", gwp: "AR6 (GWP100)", gases: [{ gas: "CO₂", value: "0.5366", unit: "kgCO₂/kWh" }], region: "华东电网", scope: "范围二", source: "生态环境部 / 国家统计局", startDate: "2024-01-01", endDate: "", status: "启用" },
  ...
  const FactorLibraryGroupMatchFields = {
    "fg-natural-gas": {
      ...
      activityDataType: "fuel_consumption",
      standardId: "std-ghgp-corporate-revised",
      standardName: "GHG Protocol Corporate Accounting and Reporting Standard",
      fuelType: "natural_gas",
    ...
    "fg-r410a": {
      ...
      activityDataType: "replenishment_amount",
      standardId: "std-iso-14064-1-2018",
      standardName: "ISO 14064-1:2018 Greenhouse gases - Part 1",
  ...
  function isConfiguredFactorGroup(group = {}) {
    return (group.factorIds || []).length > 1;
  }
  ...
  function normalizeDataSource(datasource = {}) {
    ...
    if (type === "manual") {
      normalized.frequency = "手工录入";
      normalized.energyUnit = normalized.energyUnit || normalized.unit || "kWh";
      normalized.unit = normalized.energyUnit;
      normalized.manualRows = Array.isArray(normalized.manualRows) && normalized.manualRows.length
        ? normalized.manualRows
        : [{
            energyAmount: normalized.energyAmount || "",
            timeGranularity: normalized.timeGranularity || "",
            timeDimension: normalized.timeDimension || "",
            belongingSpace: normalized.belongingSpace || ""
          }];
      const firstRow = normalized.manualRows[0] || {};
      normalized.energyAmount = normalized.energyAmount || firstRow.energyAmount || 0;
      normalized.timeGranularity = normalized.timeGranularity || firstRow.timeGranularity || "";
      normalized.timeDimension = normalized.timeDimension || firstRow.timeDimension || "";
      normalized.belongingSpace = normalized.belongingSpace || firstRow.belongingSpace || "";
    }

    if (type === "api") {
      normalized.frequency = "接口同步";
      normalized.apiPlatform = normalized.apiPlatform || normalized.meterType || "";
      normalized.apiPlatformLabel = normalized.apiPlatformLabel || normalized.meterTypeLabel || "";
      normalized.apiEnergyType = normalized.apiEnergyType || normalized.energyType || "光伏";
      normalized.energyType = normalized.energyType || normalized.apiEnergyType;
    }

    if (type === "excel") {
      normalized.frequency = "按次导入";
      normalized.energyUnit = normalized.energyUnit || normalized.unit || "kWh";
      normalized.unit = normalized.energyUnit;
      normalized.template = normalized.template || "数据上报模板.xlsx";
      normalized.excelRows = Array.isArray(normalized.excelRows) ? normalized.excelRows : [];
    }
...
function buildMatchKey(item, period = "") {
  const categoryCode = toAccountingCategoryCode(item?.belongingCategoryCode || item?.belongingCategory || item?.categoryCode || item?.category || "");
...
function matchModel(source, models = api.AccountingModels, period = "") {
  ...
  const categoryCode = toAccountingCategoryCode(source.belongingCategoryCode || source.belongingCategory || source.categoryCode || source.category || "");
 ...
 function getBoundaryClosureStatus(boundary = {}) {
  ...
  const relatedSources = (api.EmissionSources || []).filter((source) => {
    const sourceCategory = source.belongingCategoryCode || source.belongingCategory || toAccountingCategoryCode(source.categoryCode || source.category || "");
    return (
      source.status !== "已归档" &&
      source.status !== "已删除" &&
  ...
  const uniqueModelIds = new Set(rows.filter((row) => row.hasModel).map((row) => row.modelId || row.modelName).filter(Boolean));
  ...
  return {
    ...
    modelMatched: uniqueModelIds.size,
...
function refreshBoundaryClosureStatuses() {
  ...
  function getFactorBuiltinCategoryTree() {
    return clone(FactorBuiltinCategoryTree);
  }

  function getDataSourceCategoryTree() {
    return clone(DataSourceCategoryTree);
  }

  function getFactorCategoryGroupByCategory(categoryCode) {
    for (const group of FactorBuiltinCategoryTree) {
      const matchedCategory = (group.children || []).find(item => item.category === categoryCode);
      if (matchedCategory) {
        return {
          groupCode: group.groupCode,
          ...
          categoryCode: matchedCategory.category,
          categoryLabel: matchedCategory.categoryLabel
        };
      }
    }
    return {
  ...
  function toAccountingCategoryCode(categoryCode) {
    return FactorCategoryAccountingMap[categoryCode]?.categoryCode || categoryCode || "";
  }

  function toFactorMatchCategoryCode(categoryCode, source = {}) {
    const rawCategory = String(categoryCode || "");
    const sourceCategory = String(source.categoryCode || source.category || "");
    const sourceBoundaryCategory = source.belongingCategoryCode || source.belongingCategory || "";
    if (rawCategory && sourceCategory && rawCategory === sourceCategory && sourceBoundaryCategory) {
      return toAccountingCategoryCode(sourceBoundaryCategory);
    }
    return getBoundaryCategoryByFactorCategory(categoryCode)?.categoryCode || toAccountingCategoryCode(categoryCode);
  }

  function getBoundaryCategoryByFactorCategory(categoryCode) {
    const factorCategory = getSourceFactorCategoryAssignment(categoryCode)?.categoryCode || categoryCode || "";
    const savedSource = (api?.EmissionSources || [])
      .filter((source) => String(source.categoryCode || source.category || "") === String(factorCategory))
      .slice()
      .sort((a, b) => String(b.updatedAt || b.createdAt || b.id || "").localeCompare(String(a.updatedAt || a.createdAt || a.id || "")))
      .find((source) => source.belongingCategoryCode || source.belongingCategory);

    if (savedSource) {
      const category = savedSource.belongingCategoryCode || savedSource.belongingCategory || "";
      const scope = savedSource.scope || inferScopeByCategory(category) || "";
      return {
        scope,
        scopeLabel: ScopeCodeToLabel[scope] || scope || "",
        category,
        categoryCode: category,
        categoryLabel: savedSource.belongingCategoryLabel || CategoryCodeToLabel[category] || category
      };
    }

    const mapped = FactorCategoryAccountingMap[factorCategory] || null;
    if (!mapped) return null;
    return {
      scope: mapped.scope || inferScopeByCategory(mapped.categoryCode) || "",
      scopeLabel: ScopeCodeToLabel[mapped.scope] || mapped.scope || "",
      category: mapped.categoryCode,
      categoryCode: mapped.categoryCode,
      categoryLabel: mapped.categoryLabel || CategoryCodeToLabel[mapped.categoryCode] || mapped.categoryCode
    };
  }

  function getSourceFactorCategoryAssignment(categoryCode) {
    const migrated = SourceFactorCategoryAssignments[categoryCode];
    if (migrated) return migrated;

    const factorGroup = getFactorCategoryGroupByCategory(categoryCode);
    if (factorGroup?.categoryCode) {
      return {
        groupCode: factorGroup.groupCode,
        groupLabel: factorGroup.groupLabel,
        categoryCode: factorGroup.categoryCode,
        categoryLabel: factorGroup.categoryLabel
      };
    }
  ...
  function toAccountingSource(source = {}) {
    const displayCategory = source.categoryCode || source.category || "";
    const accountingCategory = toAccountingCategoryCode(displayCategory);
    return {
      ...source,
      displayCategory,
      displayCategoryCode: displayCategory,
      displayCategoryLabel: source.categoryLabel || CategoryCodeToLabel[displayCategory] || displayCategory,
      category: accountingCategory,
      categoryCode: accountingCategory,
      categoryLabel: CategoryCodeToLabel[accountingCategory] || source.categoryLabel || accountingCategory,
      scope: source.scope || inferScopeByCategory(accountingCategory, source.sourceType)
    };
  }

  function getFactorCategoryOptionsByGroup(groupCode) {
    const group = FactorBuiltinCategoryTree.find((item) => item.groupCode === groupCode);
    return (group?.children || []).map((item) => ({
      category: item.category,
      categoryCode: item.category,
      categoryLabel: item.categoryLabel,
      scope: inferScopeByCategory(item.category) || "scope3",
      scopeLabel: ScopeCodeToLabel[inferScopeByCategory(item.category) || "scope3"] || "范围三"
    }));
  }
  ...
  function resolveStandardId(model = {}) {
    ...
    const matchedStandard = [...(api?.StandardFiles || StandardFiles || []), ...FactorStandards].find((standard) =>
  ...
  const standard = (api?.StandardFiles || StandardFiles || []).find((item) => item.id === standardId)
    || FactorStandards.find((item) => item.id === standardId)
    || null;
  ...
  function getFactorMatchValue(field, model = {}, source = {}, factor = null) {
    ...
    if (field === "categoryCode") {
      return toAccountingCategoryCode(source.belongingCategoryCode || source.belongingCategory || source.categoryCode || source.category || model.categoryCode || model.category || "");
    }
    ...
    const value = source.accountingParams?.[field] ?? source[field] ?? model[field] ?? "";
    return field === "categoryCode" ? toAccountingCategoryCode(value) : value;
  }
  ...
  function matchFactorByModelAndSource(model = {}, source = {}, period = "", factorsInput = null) {
    ...
    const requiredFields = new Set((Array.isArray(rule.fields) ? rule.fields : []).filter(Boolean));
    const factors = factorsInput || api?.FactorLibraryGroups || FactorLibraryGroups || [];
    const periodValue = period || source.period || "";

    return (
      factors.map(normalizeFactorLibraryGroup).find((factor) =>
        fields.every((field) => {
          ...
          if (requiredFields.has(field) && (!expected || !actual)) return false;
  ...
  function matchSingleFactorsByModelAndSource(model = {}, source = {}, period = "") {
    ...
    const categoryCode = toAccountingCategoryCode(source.belongingCategoryCode || source.belongingCategory || source.categoryCode || source.category || model.categoryCode || model.category || "");
    ...
    return factors.map(normalizeFactorLibraryFactor).filter((factor) => {
      ...
      const matched = fields.every((field) => {
        ...
        if (field === "categoryCode") {
          return String(toAccountingCategoryCode(actualValue || factor.category || "")) === String(expectedValue || "");
        }
  ...
  function getActivityParamSchema(categoryCode) {
    ...
    const schema = schemas[toAccountingCategoryCode(categoryCode)];
  ...
  function getSourceParamUnit(source = {}, schema = null) {
    const schemas = api?.ActivityParamSchemas || ActivityParamSchemas;
    const currentSchema = schema || schemas[toAccountingCategoryCode(source.belongingCategoryCode || source.belongingCategory || source.category || source.categoryCode)] || null;
  ...
  function normalizeAccountingParams(category, formValues = {}) {
    const schemas = api?.ActivityParamSchemas || ActivityParamSchemas;
    const accountingCategory = toAccountingCategoryCode(category);
    const schema = schemas[accountingCategory] || null;
    ...
    if (!schema) {
      Object.entries(values || {}).forEach(([key, rawValue]) => {
        if (!key || key.endsWith("Custom") || rawValue === undefined || rawValue === null || rawValue === "") return;
        const customLabel = String(
          values[`${key}Custom`] ||
          labelsFromForm[key] ||
          formValues[`${key}Custom`] ||
          ""
        ).trim();
        if (rawValue === "__custom__") {
          accountingParams[key] = makeCustomParamCode(customLabel);
          accountingParamLabels[key] = customLabel || "自定义";
        } else {
          accountingParams[key] = rawValue;
          accountingParamLabels[key] = labelsFromForm[key] || rawValue;
        }
      });

      return {
        activityDataType: formValues.activityDataType || "",
        activityDataTypeLabel: formValues.activityDataTypeLabel || getActivityDataLabel(formValues.activityDataType) || "",
        activityDataLabel: formValues.activityDataLabel || formValues.activityDataTypeLabel || getActivityDataLabel(formValues.activityDataType) || "",
        accountingParams,
  ...
  function normalizeEmissionSource(source = {}) {
    const rawCategory = source.category || source.categoryCode || "";
    const factorAssignment = getSourceFactorCategoryAssignment(rawCategory);
    const category = factorAssignment?.categoryCode || rawCategory;
    const { period, ...sourceWithoutPeriod } = source;
    const accountingCategory = toAccountingCategoryCode(category);
    const activityCategory = sourceWithoutPeriod.belongingCategoryCode || sourceWithoutPeriod.belongingCategory || accountingCategory;
    const boundaryAssignment = getBoundaryCategoryByFactorCategory(category) || {};
    const factorGroup = getFactorCategoryGroupByCategory(category);
    const normalizedActivity = normalizeAccountingParams(activityCategory, {
      activityDataType: sourceWithoutPeriod.activityDataType,
      activityDataTypeLabel: sourceWithoutPeriod.activityDataTypeLabel,
    ...
    return {
      ...sourceWithoutPeriod,
      groupCode: factorAssignment?.groupCode || factorGroup.groupCode || sourceWithoutPeriod.groupCode || "",
      groupLabel: factorAssignment?.groupLabel || factorGroup.groupLabel || sourceWithoutPeriod.groupLabel || "",
      scope: sourceWithoutPeriod.scope || boundaryAssignment.scope || inferScopeByCategory(accountingCategory, sourceWithoutPeriod.sourceType),
      belongingCategory: sourceWithoutPeriod.belongingCategoryCode || sourceWithoutPeriod.belongingCategory || boundaryAssignment.categoryCode || accountingCategory,
      belongingCategoryCode: sourceWithoutPeriod.belongingCategoryCode || sourceWithoutPeriod.belongingCategory || boundaryAssignment.categoryCode || accountingCategory,
      belongingCategoryLabel: sourceWithoutPeriod.belongingCategoryLabel || boundaryAssignment.categoryLabel || CategoryCodeToLabel[accountingCategory] || accountingCategory,
      category,
      categoryCode: category,
      categoryLabel: factorAssignment?.categoryLabel || factorGroup.categoryLabel || sourceWithoutPeriod.categoryLabel || CategoryCodeToLabel[category] || category,
      boundaryCategory: factorAssignment?.categoryLabel || factorGroup.categoryLabel || sourceWithoutPeriod.boundaryCategory || sourceWithoutPeriod.categoryLabel || CategoryCodeToLabel[category] || category,
      ...normalizedActivity,
  ...
  function syncActivityParamOptionsFromSource(source = {}) {
    const category = source.belongingCategoryCode || source.belongingCategory || toAccountingCategoryCode(source.category || source.categoryCode || "");
    if (!category) return;

    const schemas = api?.ActivityParamSchemas || ActivityParamSchemas;
    let schema = schemas[category];
    const paramsFromSource = source.accountingParams || {};
    const labelsFromSource = source.accountingParamLabels || {};
    if (!schema && source.activityDataType) {
      const params = Object.keys(paramsFromSource).map((key) => ({
        key,
        label: key === "customSpecificType" ? "具体类型" : key,
        allowCustom: true,
      ...
      schema = {
        category,
        activityDataType: source.activityDataType,
        activityDataTypeLabel: source.activityDataTypeLabel || source.activityDataLabel || getActivityDataLabel(source.activityDataType) || source.activityDataType,
        activityDataLabel: source.activityDataLabel || source.activityDataTypeLabel || getActivityDataLabel(source.activityDataType) || source.activityDataType,
    ...
    } else if (schema?.custom && source.activityDataType) {
      schema = {
        ...schema,
        activityDataType: source.activityDataType,
        activityDataTypeLabel: source.activityDataTypeLabel || source.activityDataLabel || schema.activityDataTypeLabel || getActivityDataLabel(source.activityDataType) || source.activityDataType,
        activityDataLabel: source.activityDataLabel || source.activityDataTypeLabel || schema.activityDataLabel || getActivityDataLabel(source.activityDataType) || source.activityDataType,
        defaultUnit: source.unit || schema.defaultUnit || ""
      };
      api.ActivityParamSchemas = {
        ...(api.ActivityParamSchemas || {}),
        [category]: schema
  ...
  function formatSourceActivityConfig(source = {}) {
    const schemas = api?.ActivityParamSchemas || ActivityParamSchemas;
    const schema = schemas[toAccountingCategoryCode(source.belongingCategoryCode || source.belongingCategory || source.category || source.categoryCode)] || null;
      ...
      const categories = (api.BoundaryCategories || [])
        ...
        .map((item) => ({
          ...
          sources: (api.EmissionSources || []).filter((source) => {
            const sourceBoundaryCategory = source.belongingCategoryCode || source.belongingCategory || toAccountingCategoryCode(source.categoryCode || source.category || "");
            return source.scope === item.scope && sourceBoundaryCategory === item.category;
          })
        }));
      return {
        scope,
...
function getSourceCategoryTree() {
  ...
  (api.EmissionSources || []).forEach((source) => {
    ...
    const factorGroup = getFactorCategoryGroupByCategory(categoryCode) || {};
    const group = getEmissionGroupByCategory(toAccountingCategoryCode(categoryCode)) || {};
    const groupCode = factorGroup.groupCode || source.groupCode || group.groupCode || "other";
    const groupLabel = factorGroup.groupLabel || source.groupLabel || group.groupLabel || "其他";
    ...
    if (!sourceCategoryMap.has(key)) {
      sourceCategoryMap.set(key, {
        ...
        category: categoryCode,
        categoryCode,
        categoryLabel: factorGroup.categoryLabel || source.categoryLabel || CategoryCodeToLabel[categoryCode] || categoryCode,
        status: "启用",
        sources: []
      });
    }
...
function getBoundaryCategoryOptionsForSourceForm() {
  ...
  function getExpectedFactorMatchValues(model = {}, source = {}) {
    ...
    const sourceParams = source.accountingParams || source.params || {};
    return {
      categoryCode: toAccountingCategoryCode(source.belongingCategoryCode || source.belongingCategory || source.categoryCode || source.category || normalizedModel.categoryCode || normalizedModel.category || ""),
  ...
  function isFactorCandidateMatched(candidate = {}, model = {}, source = {}, period = "") {
    ...
    const requiredFields = new Set((Array.isArray(rule.fields) ? rule.fields : [])
      .filter((field) => !["categoryCode", "standardId"].includes(field)));
    ...
    const matched = fields.every((field) => {
      ...
      if (field === "categoryCode") {
        if (!expectedValue) return true;
        return String(toFactorMatchCategoryCode(actualValue || candidate.category || "", source)) === String(expectedValue || "");
      }
      if (!expectedValue) return !requiredFields.has(field);
      return String(actualValue || "") === String(expectedValue || "");
    });
  ...
  function explainFactorMismatch(model = {}, source = {}, period = "") {
    if (!model) return "未匹配核算模型";
    const normalizedModel = normalizeAccountingModel(model || {});
    const rule = normalizedModel.factorMatchRule || {};
    const fields = Array.isArray(rule.fields) && rule.fields.length
      ? Array.from(new Set(["activityDataType", ...rule.fields]))
    ...
    const expected = getExpectedFactorMatchValues(normalizedModel, source);
    const candidates = [
      ...(api?.FactorLibraryGroups || FactorLibraryGroups || []).map(normalizeFactorLibraryGroup),
      ...(api?.FactorLibraryFactors || FactorLibraryFactors || []).map(normalizeFactorLibraryFactor)
    ].filter(isEnabledItem);
    const periodValue = period || source.period || "";
    const inPeriod = candidates.filter((candidate) =>
      isPeriodInRange(periodValue, candidate.effectiveDate || candidate.startDate, candidate.expireDate || candidate.endDate)
    );
    if (!inPeriod.length) return "没有启用且在有效期内的因子";

    const fieldLabels = {
      categoryCode: "类别",
      activityDataType: "活动数据类型",
      standardId: "方法学标准",
      fuelType: "燃料类型",
    ...
    const missingRequiredFields = fields
      .filter((field) => requiredFields.has(field) && !expected[field])
      .map((field) => fieldLabels[field] || field);
    if (missingRequiredFields.length) {
      return `排放源缺少因子匹配参数：${missingRequiredFields.join("，")}`;
    }
    const mismatches = fields.map((field) => {
      const expectedValue = expected[field];
      if (!expectedValue) return "";
      const hasMatch = inPeriod.some((candidate) => {
        const actualValue = candidate[field];
        if (field === "categoryCode") {
          return String(toFactorMatchCategoryCode(actualValue || candidate.category || "", source)) === String(expectedValue || "");
        }
      ...
      return hasMatch ? "" : `${fieldLabels[field] || field}=${expectedValue}`;
    }).filter(Boolean);

    return mismatches.length
      ? `因子字段未对齐：${mismatches.join("，")}`
      : "暂无完全匹配的因子";
  }
...
const mergedAccountingModels = mergeById(AccountingModels, savedState.AccountingModels)
  ...
  const mergedFactorLibraryGroups = (savedFactorLibraryIsCurrent
    ? mergeById(FactorLibraryGroups, savedState.FactorLibraryGroups).map(normalizeFactorLibraryGroup)
    : clone(FactorLibraryGroups).map(normalizeFactorLibraryGroup))
    .filter(isConfiguredFactorGroup);
...
EmissionSources: Array.isArray(savedState.EmissionSources)
  ...
  ? mergeById(DataSources, savedState.DataSources).map(normalizeDataSource)
...
ActivityDataRecords: savedActivityRecordsIsCurrent && Array.isArray(savedState.ActivityDataRecords)
  ...
  : clone(GwpOperationLogs),
    ...
    DefaultFactorLibraryGroups: clone(FactorLibraryGroups).map(normalizeFactorLibraryGroup).filter(isConfiguredFactorGroup),
    DefaultFactorStandards: clone(FactorStandards),
    DefaultStandardFiles: clone(StandardFiles),
...
getFactorBuiltinCategoryTree,
getDataSourceCategoryTree,
getFactorCategoryGroupByCategory,
getFactorCategoryOptionsByGroup,
toAccountingCategoryCode,
toFactorMatchCategoryCode,
getSourceFactorCategoryAssignment,
getBoundaryCategoryByFactorCategory,
toAccountingSource,
...
getLatestActivityRecordBySource(sourceOrId) {
  ...
  return api.getActivityRecordsBySource(sourceOrId)[0] || null;
    ...
    getFactorStandard(standardId) {
      return api.StandardFiles.find((standard) => standard.id === standardId)
        || api.FactorStandards.find((standard) => standard.id === standardId)
        || null;
    },
    ...
    getStandardFiles() {
      return clone(api.StandardFiles || []);
    },
  ...
  try {
    ...
    upsertEmissionSource(source) {
      ...
      const boundaryCategoryCode = normalizedSource.belongingCategoryCode || normalizedSource.belongingCategory || toAccountingCategoryCode(normalizedSource.category);
      if (normalizedSource.scope && boundaryCategoryCode && !api.isBoundaryCategoryExists(normalizedSource.scope, boundaryCategoryCode)) {
  const option = api.getBoundaryCategoryOptions(normalizedSource.scope).find((item) => item.category === boundaryCategoryCode) || {};
  api.upsertBoundaryCategory({
    scope: normalizedSource.scope,
    category: boundaryCategoryCode,
    categoryLabel: normalizedSource.belongingCategoryLabel || option.categoryLabel,
    included: true,
    status: "待完善",
  ...
  return api.EmissionSources.length !== before;
    ...
    upsertStandardFile(standard) {
      const next = {
        ...standard,
        id: standard.id || `std-${Date.now()}`
      };
      const index = api.StandardFiles.findIndex((item) => item.id === next.id);

      if (index >= 0) {
        api.StandardFiles.splice(index, 1, { ...api.StandardFiles[index], ...next });
      } else {
        api.StandardFiles.unshift(next);
      }

      api.saveState();
      return api.StandardFiles.find((item) => item.id === next.id) || null;
    },
